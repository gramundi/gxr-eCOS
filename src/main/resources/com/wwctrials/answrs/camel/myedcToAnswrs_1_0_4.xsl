...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
	...
	<xsl:template match="/">
		...
		<xsl:element name="answrs">
			...
			<xsl:choose>
				...
				<!-- data_datatables -->
				<xsl:when test="/data/data">
					<xsl:call-template name="data_datatables"/>
				</xsl:when>
				...
				<xsl:when test="/data/pagestatuses">
                                        <xsl:call-template name="data_pagestatus" />
    ...
    <!-- data_pagestatus -->
	<xsl:template name="data_pagestatus">
		<xsl:element name="country">
			<xsl:element name="iso">
				<xsl:value-of select="$COUNTRY_CODE" />
			</xsl:element>
			...
			<xsl:element name="parent">
				...
				<xsl:element name="parentDb">
					<xsl:for-each select="/data/pagestatuses/pagestatus">
						<xsl:element name="form">
							<xsl:element name="id">
								<xsl:value-of select="/data/@type" />
							</xsl:element>
	...
	<!-- datatable - requires param1 = '<value>' (see eCOS page designs e.g. 'DV' = date of visit) -->
	<!-- =============================================================== -->
	<xsl:template name="data_datatables">
		<xsl:element name="country">
			<xsl:element name="iso">
				<xsl:value-of select="$COUNTRY_CODE" />
			</xsl:element>
			...
			<xsl:element name="parent">
				...
				<xsl:element name="parentDb">
					<xsl:for-each select="/data/data/datarow">
						<xsl:element name="form">
							<xsl:element name="id">
								<xsl:value-of select="/data/data/@table" />
							</xsl:element>
							...
							<xsl:element name="iterator">
								...
								<!-- loop through each one -->
								<xsl:call-template name="datatable_item_values" />
	...
	<!-- datatable item values  -->
	<!-- =============================================================== -->
	<xsl:template name="datatable_item_values">
		<xsl:for-each select="*">
			<xsl:element name="update">
				<xsl:element name="id">
